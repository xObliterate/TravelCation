            ...
            <ContentTemplate>
                ...
                <asp:MultiView ID="mv_services" runat="server" EnableViewState="false" ActiveViewIndex="0">
                    ...
                    <asp:View ID="view_hotel" runat="server">
                        <asp:Panel ID="panel_hotel" runat="server" DefaultButton="btn_submitHotel">
                            <div class="row">
                    ...
                    <asp:View ID="view_flight" runat="server">
                        <asp:Panel ID="panel_flight" runat="server" DefaultButton="btn_submitFlight">
                    ...
                    <!--Multiview_Flight+Hotel-->
               <%--     <asp:View ID="view_flightAndHotel" runat="server">
                        <asp:Panel ID="panel_flightAndHotel" runat="server">
                            <div class="row">
                                <div class="input-field col s6">
                                    <i class="material-icons prefix">location_on</i>
                                    <asp:TextBox ID="TextBox1" runat="server" placeholder="Flying From"></asp:TextBox>
                                </div>
                                <div class="input-field col s6">
                                    <i class="material-icons prefix">location_on</i>
                                    <asp:TextBox ID="TextBox2" runat="server" placeholder="Flying To"></asp:TextBox>
                                </div>
                            </div>
                        </asp:Panel>
                    </asp:View>--%>

                    <!--Multiview_Attraction-->
                    <asp:View ID="view_attraction" runat="server">
                    </asp:View>
